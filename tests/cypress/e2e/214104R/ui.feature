...
Then I should see the dashboard When I click "Sales" in navigation 
Then I should see the heading "Sales" And I should see "Sell Plant" button And I should see the "Delete" icon
...
Then I should see the dashboard When I click "Sales" in navigation 
Then I should see the heading "Sales" And I should not see "Sell Plant" button And I should not see the "Delete" icon
...
When I click "Sales" in navigation And I click "Sell Plant" button 
And I select the second option from the plant dropdown 
And I enter "1" in "quantity" field And I click "Sell" button 
Then I should be redirected to the Sales List And the new sale should appear at the top of the list
